...
public class GameMidlet
{
	...
	public static int intVERSION = 250;
	...
	{
		HsnrConfig.EnableHsnr();
		HsnrLog.Log("INIT", "initGame: EnableHsnr done, hsnr=" + HsnrConfig.useHsnrProtocol + " servers=" + HsnrConfig.servers.Length);
		instance = this;
